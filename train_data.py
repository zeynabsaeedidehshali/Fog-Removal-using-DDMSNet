...
class TrainData(data.Dataset):
    def __init__(self, crop_size, train_data_dir):
        ...
        with open(train_list) as f:
            ...
            snow_names = ['/home/mozhan/Downloads/0ddsnow/Deep-Dense-Multi-scale-Network-for-Snow-Removal/train/foggy/' + i.split('  ')[0].strip() for i in contents]
            gt_names = ['/home/mozhan/Downloads/0ddsnow/Deep-Dense-Multi-scale-Network-for-Snow-Removal/train/gt/' + i.split('  ')[1].strip() for i in contents]
